...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#FF5757' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#FF5757' : '#FF5757',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#FF5757',

  // secondary colors
  secondary1: darkMode ? '#FF5757' : '#FF5757',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #FF575730 0%, #fff 0%)`
})
